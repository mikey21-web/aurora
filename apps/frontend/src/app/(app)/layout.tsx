    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          genericOauth={!!process.env.AURRA_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_AURRA_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_AURRA_OAUTH_DISPLAY_NAME!}
        ...
        >
          <SentryComponent>
            ...
            <FacebookComponent />
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'aurra.app' : 'aurra.app'}
            >
              <PHProvider
