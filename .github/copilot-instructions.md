...
# Copilot Coding Agent Instructions for Aurora
...
- SDK (`apps/sdk`) provides programmatic access to Aurora features.
...
## Documentation
- Main docs: https://docs.aurora.com/
- Developer guide: https://docs.aurora.com/developer-guide
- Public API: https://docs.aurora.com/public-api
