export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Aurora, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Aurora seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Aurora!
  ...
  },
  {
    ...
    content: (
      <>
        Aurora changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Aurora, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Aurora =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Aurora, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Aurora, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose Aurora? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        Aurora is an AI-powered scheduling tool that allows you to plan and
        automate posts across 28+ platforms, including X, LinkedIn, BlueSky, and
        Mastodon. {'\n\n'}
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Aurora can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Aurora makes it so easy to plan ahead. The AI suggestions are relevant,
